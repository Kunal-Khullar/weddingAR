...
const Product = () => {
    return (
      ...
      <div id="product"className="top_container">
        <Row >
          
          <Col  data-aos="fade-right"
      data-aos-delay="50"
      data-aos-duration="2000"
      data-aos-easing="ease-in-out-cubic" className="product_details col-md-7 ">
          ...
          <Col className="product_gif col-md-5 " data-aos="fade-left"
      data-aos-delay="50"
      data-aos-duration="2000"
